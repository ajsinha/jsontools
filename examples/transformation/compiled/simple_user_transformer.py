...
Auto-generated from: examples/transformation/mappings/simple_user.smap
Generated at: 2026-01-30T02:11:56.852560
...
class SimpleUserTransformer:
    ...
    def register_function(self, name: str, func: Callable) -> "SimpleUserTransformer":
    ...
    def transform(self, source: Dict[str, Any]) -> Dict[str, Any]:
        ...
        _v = self._get_array_values(source, "user.tags[*]")
        _v = str(_v).lower() if _v is not None else None
        ...
        _v = str(uuid.uuid4())
        self._set_value(target, "transformId", _v)
...
if __name__ == "__main__":
    ...
    transformer = SimpleUserTransformer()
