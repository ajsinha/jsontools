...
Generated: 2026-01-29T14:57:05.090480
...
class User:
    ...
    def _get_required_fields(cls) -> List[str]:
        """Get list of required field names."""
        return ['id_', 'email', 'username', 'role', 'status']

    @classmethod
    def _get_enum_constraints(cls) -> Dict[str, List[Any]]:
        """Get enum constraints for fields."""
        return {'role': ['admin', 'moderator', 'user', 'guest'], 'status': ['active', 'inactive', 'suspended', 'pending']}
