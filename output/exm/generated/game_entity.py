...
Generated: 2026-01-29T13:36:20.829058
...
class Animation:
    ...
    clips: Optional[List["AnonymousObject"]] = field(default_factory=list)
...
class GameEntity:
    ...
    components: Optional[List["AnonymousObject"]] = field(default_factory=list)
    colliders: Optional[List["AnonymousObject"]] = field(default_factory=list)
    rigidBody: Optional["AnonymousObject"] = None
    renderer: Optional["AnonymousObject"] = None
    scripts: Optional[List["AnonymousObject"]] = field(default_factory=list)
    animation: Optional["Animation"] = None
    children: Optional[List["Gameentity"]] = field(default_factory=list)
